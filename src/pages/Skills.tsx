        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            >
              ...
              levels across different areas of frontend development.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          {categories.map((category, categoryIndex) => {
            ...
            return (
              <motion.div
                ...
                className="mb-16"
              >
                <h2 className="text-h3 font-bold mb-8 text-center">
                  {category}
                </h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            {[
              ...
              {
                level: 'Intermediate',
                description: 'Comfortable with most features',
                color: 'bg-yellow-500',
              },
              {
                level: 'Beginner',
              ...
              >
                <div
                  className={`w-4 h-4 ${item.color} rounded-full mx-auto mb-3`}
                ></div>
