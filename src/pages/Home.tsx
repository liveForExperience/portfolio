          ...
          >
            {[
              ...
              },
              {
                ...
                description: t(
                  'featuredWork.projects.designSystem.description'
                ),
          ...
          >
            <motion.div variants={fadeUp} className="text-center">
              <h3 className="text-h3 font-semibold mb-4">
                {t('highlights.featuredProjects')}
              </h3>
              <p className="text-muted">
                {t('highlights.featuredProjectsDesc')}
              </p>
            </motion.div>
            <motion.div variants={fadeUp} className="text-center">
              <h3 className="text-h3 font-semibold mb-4">
                {t('highlights.technicalExcellence')}
              </h3>
              <p className="text-muted">
                {t('highlights.technicalExcellenceDesc')}
              </p>
            </motion.div>
            <motion.div variants={fadeUp} className="text-center">
              <h3 className="text-h3 font-semibold mb-4">
                {t('highlights.creativeVision')}
              </h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-muted max-w-2xl mx-auto">
              Specialized skills in modern web development and creative
              problem-solving
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-muted">
                <p>
                  Passionate frontend architect with 5+ years of experience
                  crafting exceptional digital experiences. I specialize in
                  building scalable, performant web applications using modern
                  technologies like React, TypeScript, and cutting-edge design
                  systems.
                </p>
                <p>
                  My approach combines technical excellence with creative
                  vision, ensuring every project not only functions flawlessly
                  but also delivers an outstanding user experience. I believe in
                  writing clean, maintainable code and staying at the forefront
                  of web development trends.
                </p>
                <p>
                  When I'm not coding, you'll find me exploring new
                  technologies, reading about design principles, or enjoying
                  football matches. I'm always eager to take on new challenges
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="group p-8 bg-surface rounded-xl border border-surface hover:border-accent transition-all duration-300"
            >
              <div className="text-4xl mb-4">📚</div>
              <h3 className="text-h3 font-semibold mb-4 group-hover:text-accent transition-colors">
                Reading & Learning
              </h3>
              <p className="text-muted mb-4">
                Curated collection of books on technology, design, and
            ...
            >
              ...
              <p className="text-muted mb-4">
                Highlights and moments from the beautiful game. Football teaches
